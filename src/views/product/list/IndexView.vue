...
<template>
  <div>
    <div class="bg-white border-b border-gray-200 fixed z-30 w-full">
    ...
    <div class="flex overflow-hidden pt-12">
            ...
            <div class="flex-1">
              <ul>
                <li v-for="(asideMenuItem, index) in asideMenuItems" :key="`asideMenuItem${index}`">
                  ...
                  <ul
                    :class="{
                      hidden: !asideMenuItem.isActived && !!asideMenuItem.childrenMenu?.length,
                    }"
                  >
                    <li
      ...
      <div id="main-content" class="h-full w-full bg-gray-50 relative overflow-y-auto lg:ml-52">
          ...
          <div class="pt-6 px-4">
            ...
            <div class="mt-4 w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
              <div
                ...
                v-for="(item, index) in currentOverview"
                :key="index"
              >
                <div class="flex items-center">
                  <div class="flex-shrink-0">
                  ...
                  <div
                    ...
                    :class="item.percent > 0 ? 'text-green-500' : 'text-red-500'"
                  >
                    {{ item.percent }}%
        ...
        <p class="text-center text-sm text-gray-500 my-10">
          &copy; 2019-2021
          <a href="#" class="hover:underline" target="_blank">Themesberg</a>. All rights reserved.
        </p>
      </div>
    </div>
  </div>
